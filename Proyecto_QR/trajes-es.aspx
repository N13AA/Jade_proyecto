<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="trajes-es.aspx.cs" Inherits="Proyecto_QR.trajes_es" %>
                    ...
                    <li class="nav-item dropdown">
                       ...
                       <a class="nav-link dropdown-toggle"  id="navbarDropdown2" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Idioma</a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><hr class="dropdown-divider" /></li>
                            <li><a class="dropdown-item" href="trajes-eng.aspx">English</a></li>
                                </ul>
                        </li>
                         </ul>
                  <form class="d-flex">
