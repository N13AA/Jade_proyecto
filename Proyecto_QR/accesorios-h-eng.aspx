<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="accesorios-h-eng.aspx.cs" Inherits="Proyecto_QR.accesorios_h_eng" %>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="Inicio-eng.aspx">Home</a></li>
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Accessories for Gentlemen</h1>
