<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pantalones-m-eng.aspx.cs" Inherits="  Proyecto_QR.pantalones_m_eng" %>
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Trousers for ladies</h1>
